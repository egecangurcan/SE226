...
# Task1
print("Please Enter 2 Numbers between 1-999 (inclusive). The first number must be greater than the second one.")
num1 = int(input("Please Enter Number1 : "))
num2 = int(input("Please Enter Number2 : "))

if 1 <= num1 <= 999 and 1 <= num2 <= 999 and num1 > num2:
    print(words[num2 - 1:num1])
else:
    print("Invalid numbers. The first number must be greater than the second one.")
...
for i in range(8):
    ...
    user_number = int(input("Please enter a number between 3 and 7, inclusive: "))

    while user_number < 3 or user_number > 7:
        user_number = int(input("Invalid number. Please enter a number between 3 and 7, inclusive."))
...
if key_remove.isdigit():
    key_remove = int(key_remove)
    if key_remove in my_dict:
        del my_dict[key_remove]
        print(f"Key {key_remove} is removed successfully.")
    else:
        print(f"Key {key_remove} not found.")
else:
    print("Invalid key.")
...
# Task 5-d
print("Maximum age: ", max(united_we_stand.values()))
print("Minimum age: ", min(united_we_stand.values()))
