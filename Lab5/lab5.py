...
def rep_with_upper(string):
    char = random.choice(string.lower())
...
def search_letter(source, key):
    return key.lower() in source.lower()
...
password: str = passGen(user_number)
final_password = swap_letters(rep_with_upper(password))

print(f"Initial password: {password}")
print(f"Final password: {final_password}")

first_letter = input("Please enter the first letter of your name: ")

print(search_letter(final_password, first_letter))
